...
(err/rt-test (readstr "#fl(1.5 0.33 0.3 (1 2))") exn:fail:contract?)
(err/rt-test (readstr "#fx(1000 76 100000 (1 2))") exn:fail:contract?)
(err/rt-test (readstr "#fl(1.5 0.33 0.3 'a)") exn:fail:contract?)
(err/rt-test (readstr "#fx(1000 76 100000 'a)") exn:fail:contract?)
